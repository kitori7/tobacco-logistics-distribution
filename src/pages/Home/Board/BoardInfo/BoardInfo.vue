<template>
  <div class="BoardInfo">
    <info-search @item-add="propItemAdd" @item-delete="propItemDelete" @item-search="propItemSearch"
      @item-reset="propItemReset" @item-state="propItemStateChange" :feedbackType="feedbackType"></info-search>
    <info-table class="info-table" :table-data="boardStore.boardData?.dataCurrentPage" @item-click="propItemClick"
      ref="InfoTableRef" :feedbackType="feedbackType"></info-table>
    <info-item ref="InfoItemRef" @reply-click="propReplyClick" :feedbackType="feedbackType"></info-item>
    <info-reply ref="InfoReplyRef" :feedbackType="feedbackType" @renew-click="submitReplyClick"></info-reply>
    <el-pagination layout="prev, pager, next" :current-page="pageData.pageNum" :page-size="pageData.pageSize"
      :total="boardStore.boardData.totalCount" @current-change="currentChange" />
